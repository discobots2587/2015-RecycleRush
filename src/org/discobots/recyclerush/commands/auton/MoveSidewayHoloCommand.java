...
*
*/
public class MoveSidewayHoloCommand extends Command {
	long time;
	long duration;
	double speed;
	...
	public MoveSidewayHoloCommand(long time, double speed) {
	...
	protected void execute() {
		...
		Robot.driveTrainSub.holonomicDriveRamp(0, speed, controllerOutputVal);
	}
